...
from cfg import (ADDRESS, PORT, TS_USER, TS_PASSWORD,
                 PERSISTENCE_FILE)


class TransmissionBroker:
    def __init__(self):
        print(f"user={TS_USER}, password={TS_PASSWORD}")
        self.conn = Client(ADDRESS, PORT, user=TS_USER, password=TS_PASSWORD)
